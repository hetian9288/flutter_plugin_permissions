package cn.cnganen.flutterpluginpermissions
...
class FlutterPluginPermissionsPlugin(private val registrar: Registrar, private var requestedPermissions: MutableList<String>? = null): MethodCallHandler {
  ...
  companion object {
    ...
    fun registerWith(registrar: Registrar) {
      val channel = MethodChannel(registrar.messenger(), "flutter_plugin_permissions")
      val instance = FlutterPluginPermissionsPlugin(registrar)
